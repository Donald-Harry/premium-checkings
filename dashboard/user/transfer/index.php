                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30">
                            ...
                            <form method="POST" action="<?= ROOT_URL ?>dashboard/user/transfer/security/check_1.php" id="transfer_form" oninput="checkForm()" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="button-group d-flex justify-content-center flex-wrap">
                                            ...
                                            <button type="submit" id="submitBtn"  class="waves-effect main-btn primary-btn btn-hover m-2 unclickable" disabled>
                                                Transfer
                                            </button>
