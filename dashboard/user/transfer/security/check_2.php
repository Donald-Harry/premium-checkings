...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $code_1 = mysqli_real_escape_string($conn, $_POST["code_1"]);
}
...
if ($get_code->num_rows > 0) {
    while ($row = $get_code->fetch_assoc()) {
        $code_name = $row['second_code_name'];
        $first_code = $row['first_code_number'];
    }
}
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30">
                            ...
                            <form method="POST" action="<?= ROOT_URL ?>dashboard/user/transfer/security/check_3.php" id="transfer_form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-style-1">
                                            ...
                                            <input class="form-control" name="code_2" placeholder="*****" type="text" required="">
                                        </div>
                                    </div>
                                    <!-- end col -->
                                    <div class="col-12">
