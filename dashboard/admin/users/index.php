...
$get_user_details = $conn->query("SELECT * FROM users");
?>
<!DOCTYPE html>
<html lang="en">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <span class="fw-bold"><?= $row['currency'] ?><?= $row['totalbal'] ?>.00</span>
                                                            <span class="d-block text--primary"><?= $row['account_number'] ?></span>
                                                        </td>
                                                        <td>
                                                            <div class="button--group">
                                                                <a href="<?= ROOT_URL ?>dashboard/admin/users/details.php?user=<?= $row['id'] ?>" class="btn btn-outline--primary">
                                                                    <i class="fa-solid fa-desktop"></i> Details
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
