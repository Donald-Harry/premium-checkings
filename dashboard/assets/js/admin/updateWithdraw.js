const updateWithdrawHistoryForm = document.querySelector("#update_withdraw_form"),
updateWithdrawHistoryBtns = document.querySelectorAll(".update_withdraw_btn"),
deleteWithdrawHistoryBtns = document.querySelectorAll(".delete_withdraw_btn");

updateWithdrawHistoryForm.onsubmit = (e) =>{
    e.preventDefault(); // preventing form from submitting
}

updateWithdrawHistoryBtns.forEach(updateWithdrawHistoryBtn =>{
    updateWithdrawHistoryBtn.onclick = ()=>{
        // console.log("Working good");
        let xhr = new XMLHttpRequest();
        xhr.open("POST", "../../../backend/withdraw/updateWithdraw.php", true);
        xhr.onload = () =>{
        ...
        let formData = new FormData(updateWithdrawHistoryForm); //creating new formdata object
