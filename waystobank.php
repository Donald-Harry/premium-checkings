...
<php class="no-js" lang="en">
  ...
  <![endif]-->
    ...
    <div class="loader">
                        ...
                        <div class="bg-white p-5 rounded-top-md">
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                    <h1 class="mb-0">Bank with Premium Checkings</h1>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="text-md-end mt-3 mt-md-0">
                                        <a href="#!" class="btn btn-primary">Online Login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="mt-n6">
            <div class="container " style="height: 463px;">
                <div class="row bg__green h-100">
            ...
            <div class="container">
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-7 col-md-6 col-sm-6">
                        <div class="trad-bank-img">
                            <img src="assets/images/13566.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-7 col-md-6 col-sm-6">
                        <div class="trad-bank-img">
                            <img src="assets/images/9077.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row mb-5 align-items-center flex-row-reverse">
                    <div class="col-lg-7 col-md-6 col-sm-6">
                        <div class="trad-bank-img">
                            <img src="assets/images/105392.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-5">
                ...
                <div class="row mb-5 align-items-center">
                    <div class="col-lg-7 col-md-6 col-sm-6">
                        <div class="trad-bank-img">
                            <img src="assets/images/13567.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <h2>Debit Card</h2>
